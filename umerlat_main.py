...
FOLDER_LOC = 'photos/run_Liam_moments/' # folder to save data
...
np.savetxt(FOLDER_LOC+'centroid_x_y.txt',np.array([top.hzbar[0,idx,0], top.hxbar[0,idx,0], top.hybar[0,idx,0]]).T)
np.savetxt(FOLDER_LOC+'centroid_xp_yp.txt',np.array([top.hzbar[0,idx,0], top.hxpbar[0,idx,0], top.hypbar[0,idx,0]]).T)
